<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    "folder-open":
      '<path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v2H5.5a2 2 0 0 0-2 1.7z"/><path d="M3 13.7A2 2 0 0 1 5.5 12H21l-2.4 6.4a2 2 0 0 1-1.9 1.3H5a2 2 0 0 1-2-2z"/>',
    calendar:
    ...
    unlink:
      '<path d="m18.84 12.25 1.72-1.71a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="m5.17 11.75-1.72 1.71a5 5 0 0 0 7.07 7.07l1.72-1.71"/><path d="M8 2v3M2 8h3M16 19v3M19 16h3"/>',
    external:
    ...
    magnet:
      '<path d="M6 15a6 6 0 0 0 12 0V3h-4v12a2 2 0 0 1-4 0V3H6z"/><path d="M6 8h4M14 8h4"/>',
  };
</script>
